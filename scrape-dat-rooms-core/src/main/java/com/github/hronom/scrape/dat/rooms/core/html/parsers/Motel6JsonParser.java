...
import com.github.hronom.scrape.dat.rooms.core.html.parsers.pojos.Motel6JsonAvailableRatePojo;
import com.github.hronom.scrape.dat.rooms.core.html.parsers.pojos.Motel6JsonResponsePojo;
import com.github.hronom.scrape.dat.rooms.core.html.parsers.pojos.Motel6JsonRoomRatePojo;
    ...
    public ArrayList<RoomInfo> parse(String html, RoomPhotoDownloader downloader) {
        ...
        try {
            ...
            Motel6JsonResponsePojo motel6JsonResponsePojo = mapper
                .readValue(html, Motel6JsonResponsePojo.class);
