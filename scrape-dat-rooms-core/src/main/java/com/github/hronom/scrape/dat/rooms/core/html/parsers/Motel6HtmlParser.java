...
public class Motel6HtmlParser implements HtmlParser {
    private static final Logger logger = LogManager.getLogger();

    private final String baseUri = "https://www.motel6.com/";
    ...
    public ArrayList<RoomInfo> parse(String html, RoomPhotoDownloader downloader) {
        ...
        Elements selectedElements = doc.select("div[class=\"roomList-container ng-scope\"]");
